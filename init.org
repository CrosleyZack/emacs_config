    ...
    #+BEGIN_SRC emacs-lisp
      (use-package evil-maps
         ...
         (progn
            ...
            (define-key evil-window-map (kbd "e h") 'buf-move-left)
            (define-key evil-window-map (kbd "e j") 'buf-move-down)
            (define-key evil-window-map (kbd "e k") 'buf-move-up)
            (define-key evil-window-map (kbd "e l") 'buf-move-right)))
      ;;    :bind (("C-w e k" . buf-move-up)
      ;;           ("C-w e j" . buf-move-down)
      ;;           ("C-w e h" . buf-move-left)
      ;;           ("C-w e l" . buf-move-right)))
